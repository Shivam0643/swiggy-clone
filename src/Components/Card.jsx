    ...
    return (
        <div className={`${props.width} shrink-0 mb-3`}>
            <div className='group h-[182px]  rounded-[15px] overflow-hidden relative'>
                <img className='group-hover:scale-110 duration-500 object-cover w-full h-full' src={"images/" + props.image} alt="" />
            ...
            <div className='text-slate-700'>{props.name} <br /> {props.place}
            </div>
        </div>
    )
}
